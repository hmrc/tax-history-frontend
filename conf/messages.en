################################### Generic Labels ################################################
service.name = View client income and tax records
...
lbl.income.tax=Income Tax paid
...
# PTA Navigation
# ----------------------------------------------------------
nav.home = Agent services home
nav.client = Select client
nav.year = Select year
...
employmenthistory.title=Client income record
...
employmenthistory.eyu.pay=Income amount
employmenthistory.eyu.studentloan=Student loan amount
employmenthistory.eyu.tax=Tax
employmenthistory.eyu.date.received=Date
...
employmenthistory.caveat.p1.text=This is the most up-to-date information we hold for this client. It is the same information we used to provide by phone.
employmenthistory.caveat.p2.text=If you need to query this information, check with your client first before you contact us.
...
employmenthistory.state.pensions.text.weekly.p1=Your client started receiving a State Pension of {0} per week on {1}.
employmenthistory.state.pensions.text.weekly.p2=Their state pension income up to {0} is {1}.
employmenthistory.state.pensions.text.yearly=Your client''s State Pension this tax year was {0}.
employmenthistory.allowances.eya.summary.header=EYA Explained
employmenthistory.allowances.eya.summary.detail1=HMRC can adjust a client’s tax code to refund tax that was overpaid in previous years. This is called an Earlier Years Adjustment (EYA).
employmenthistory.allowances.eya.summary.detail2=A tax overpayment may have arisen when tax relief was claimed for such things as job expenses or professional subscriptions.
...
employmenthistory.error.no-record=No record
...
employmenthistory.al.EarlierYearsAdjustment=Earlier years adjustment (EYA)
...
employmenthistory.select.client.title=Enter a client''s National Insurance number
...
################################ Employment Details ####################################################
employmenthistory.employment.details.title=Client single record
...
employmenthistory.eyu.button=View updates to this income record
employmenthistory.eyu.caveat=Your client's year-to-date income record includes these updates.
employmenthistory.eyu.updates.part1=There are
employmenthistory.eyu.updates.part2=updates to this clients income record.
employmenthistory.eyu.updates.single.part1=There is
employmenthistory.eyu.updates.single.part2=update to this clients income record.
employmenthistory.company.benefit.caveat=Benefits are confirmed when an employer submits form P11D to HMRC. Forecasted benefits may be carried forward from a previous year or estimated from other sources, but are not confirmed until a P11D is received.
employmenthistory.student.loans=Student loan repaid

################################## Select tax year ####################################################
employmenthistory.select.tax.year.title=Select the tax year you want to view
...
employmenthistory.mci.restricted.title=You do not have access to this client''s income record
...
employmenthistory.deceased.title=You do not have access to this client''s income record
employmenthistory.deceased.select.client.link.text=Enter another client''s National Insurance number
employmenthistory.no.data.title=The client’s income record contains no data for this tax year
...
employmenthistory.technical.error.title=Service unavailable
